...
router.get('/stay-records/:pppid', cacheMiddleware, TenantGetController.getTenantsStayRecords);
...
router.post('/remove-all-tenants/:propertyPpid', OwnerVacateController.removeAllTenantsFromProperty);
